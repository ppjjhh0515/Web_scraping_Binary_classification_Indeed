...
def save_vectors(X_train_vectorized, X_test_vectorized, Y_train_vectorized, Y_test_vectorized, path):
    ...
    sparse.save_npz("vecdata/X_train_vec.npz", X_train_vectorized)
    sparse.save_npz("vecdata/X_test_vec.npz", X_test_vectorized)
    np.save("vecdata/Y_train_vec.npy", Y_train_vectorized)
    np.save("vecdata/Y_test_vec.npy", Y_test_vectorized)

"""Execute main function to see counts for distinct variables and store vectors for training & testing"""
if __name__ == '__main__':
    #path of the folder / change it for desired path and where data belongs
    path = '/Users/junghopark/Desktop/Stevens_Coursework/Spring_2021/BIA 660 Web mining/Final Project/data3'
