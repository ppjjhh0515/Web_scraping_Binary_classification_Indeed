...
def import_vectors(path):
    X_train_vector = sparse.load_npz('{}/vecdata/X_train_vec.npz'.format(path))
    X_test_vector = sparse.load_npz('{}/vecdata/X_test_vec.npz'.format(path))
    Y_train_vector = np.load('{}/vecdata/Y_train_vec.npy'.format(path))
    Y_test_vector = np.load('{}/vecdata/Y_test_vec.npy'.format(path))
